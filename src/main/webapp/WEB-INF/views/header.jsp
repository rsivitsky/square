        ...
        <ul id="signInDropdown" class="nav navbar-nav navbar-right">
            <li class="dropdown">
                <button type="button" id="dropdownMenu1" data-toggle="dropdown"
                    ...
                    <i class="glyphicon glyphicon-user color-blue"></i> ${login} <span class="caret"></span></button>
                            ...
                            <form action="${loginUrl}" method="post">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <!--LOGIN-->
                                        <input id="login" name="j_username" placeholder=${auth_login} class="form-control"
                                               type="login"
                                ...
                                <span class="input-group-addon"><i
                                        ...
                                        <!--PASSWORD-->
                                        <input id="password" name="j_password" placeholder=${auth_passw} class="form-control"
                                               type="password"
